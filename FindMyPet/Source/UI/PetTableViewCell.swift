...
class PetTableViewCell: UITableViewCell {
  ...
  override func awakeFromNib() {
    ...
    self.petImageView.layer.borderColor = UIColor.avatarBorderColor().CGColor
  }
  ...
  func displayPet(displayablePet: DisplayablePet) {
    petImageView.setImageWithURL(displayablePet.avatarImageURL, placeholderImage: UIImage(named: "loader"))
